...
export function ServicesSection() {
  ...
  return (
    <section
      id="services"
      className="min-h-screen flex items-center py-24 md:py-32 relative bg-background dark:bg-black overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 relative z-10">
        <ScrollReveal delay={0.2}>
          <h2 className="text-3xl md:text-5xl font-mono text-foreground dark:text-white mb-6 tracking-wider text-center">
            SERVICES
          </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 lg:gap-10 mb-12 md:mb-16 lg:mb-20">
            {cards.map((c, idx) => (
              <button
                ...
                className={`relative w-full min-w-0 rounded-2xl md:rounded-3xl overflow-hidden border border-foreground/20 dark:border-white/20 shadow-xl transition-all duration-500 group text-left hover:-translate-y-1 focus-visible:-translate-y-1 focus:outline-none
                  ...
                  ${
                    activePanel === c.title
                      ? "ring-2 ring-foreground/40 dark:ring-white/40 active-panel"
                      : "ring-0"
                  }`}
              >
                <img
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-background/80 dark:from-black/80 via-background/20 dark:via-black/20 to-transparent" />
                ...
                <div className="pointer-events-none absolute inset-0 flex items-start justify-center pt-3">
                  <span className="inline-flex items-center rounded-full bg-background/60 dark:bg-black/60 text-foreground/90 dark:text-white/90 border border-foreground/25 dark:border-white/25 px-2 py-1 font-mono text-[10px] md:text-xs tracking-wide md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-300">
                    Tap image for details
                  </span>
                </div>

                <div className="absolute bottom-6 left-6 right-6">
                  <div className="bg-background/60 dark:bg-black/60 backdrop-blur-sm border border-foreground/20 dark:border-white/20 rounded-lg p-6">
                    <p className="text-foreground dark:text-white font-mono text-2xl md:text-3xl lg:text-4xl font-light tracking-wide mb-2">
                      {c.title}
                    </p>
                    <p className="text-foreground/80 dark:text-white/80 font-mono text-sm md:text-base tracking-wide leading-relaxed">
                      {c.subtitle}
                    </p>
                  </div>
                </div>
        ...
        <ScrollReveal delay={0.45}>
          {activePanel === "EPC" && (
            <div
              id="panel-epc"
              className="epc-panel-drag-expand border border-foreground/20 dark:border-white/20 rounded-xl md:rounded-2xl p-4 md:p-6 lg:p-8 backdrop-blur-sm bg-foreground/5 dark:bg-white/5 mb-8 md:mb-10 lg:mb-12 shadow-2xl relative overflow-hidden"
              style={{
            ...
            >
              ...
              <div className="absolute inset-0 opacity-20 pointer-events-none">
                ...
                <div className="particle-drift absolute top-1/2 left-1/4 w-1 h-1 bg-foreground/15 dark:bg-white/15 rounded-full animate-pulse"></div>
              </div>
              ...
              <h3
                className="content-cascade text-lg md:text-xl font-mono text-foreground dark:text-white tracking-wider mb-4 md:mb-6 relative z-10"
              ...
              <div className="mb-6 md:mb-8 lg:mb-10">
                <h4
                  className="content-cascade text-base md:text-lg font-mono text-foreground dark:text-white tracking-wider mb-3 md:mb-4 relative z-10"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
                  <div
                    className="epc-card-emerge epc-card-hover epc-card border border-foreground/15 dark:border-white/15 rounded-lg overflow-hidden cursor-pointer hover:border-foreground/30 dark:hover:border-white/30 hover:shadow-lg transition-all duration-500 group transform hover:-translate-y-2 hover:scale-105"
                  ...
                  >
                    ...
                    <div className="p-4">
                      <h5 className="text-sm font-mono text-foreground dark:text-white mb-2 group-hover:text-blue-300 transition-colors">
                        Rooftop
                      </h5>
                      <p className="text-xs font-mono text-foreground/70 dark:text-white/70 leading-relaxed">
              ...
              <div>
                <h4 className="text-lg font-mono text-foreground dark:text-white tracking-wider mb-4 flex items-center gap-3">
                ...
                <div
                  className={`epc-card-emerge epc-card-hover border-2 border-foreground/15 dark:border-white/15 rounded-xl overflow-hidden cursor-pointer transition-all duration-500 group relative transform hover:-translate-y-2 hover:scale-105 ${
                ...
                >
                  <div className="relative overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-background/90 dark:from-black/90 via-background/40 dark:via-black/40 to-transparent" />
                  ...
                  <div className="pointer-events-none absolute top-4 right-4">
                    {isNavigating ? (
                      <span className="inline-flex items-center rounded-full bg-blue-600/80 text-foreground dark:text-white border border-blue-400/50 px-3 py-1 font-mono text-xs tracking-wide">
                        Loading...
                      </span>
                    ) : (
                      <span className="inline-flex items-center rounded-full bg-background/60 dark:bg-black/60 text-foreground/90 dark:text-white/90 border border-foreground/25 dark:border-white/25 px-3 py-1 font-mono text-xs tracking-wide opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        Click for more details →
                      </span>
                    )}
                  </div>
                  ...
                  <div className="p-6">
                    ...
                    <div className="mb-4">
                      <h5 className="text-lg font-mono text-foreground dark:text-white mb-2">
                        GARUDA
                      </h5>
                      ...
                      <p className="text-sm font-mono text-foreground/80 dark:text-white/80 leading-relaxed mb-2">
                      ...
                      <p className="text-sm font-mono text-foreground/80 dark:text-white/80 leading-relaxed">
                    ...
                    <div className="mt-4 pt-4 border-t border-foreground/10 dark:border-white/10">
                      <p className="text-xs font-mono text-foreground/60 dark:text-white/60 italic text-center">
        ...
        <ScrollReveal delay={0.5}>
          {activePanel === "OEM" && (
            <div
              id="panel-oem"
              className="oem-panel-drag-expand border border-foreground/20 dark:border-white/20 rounded-2xl p-8 backdrop-blur-sm bg-foreground/5 dark:bg-white/5 mb-12 shadow-2xl relative overflow-hidden"
              style={{
                transformOrigin: "center top",
                animationDelay: "0.1s",
              }}
            >
              {/* Enhanced animated background particles */}
              <div className="absolute inset-0 opacity-20 pointer-events-none">
                <div className="particle-drift absolute top-10 left-10 w-2 h-2 bg-foreground/20 dark:bg-white/20 rounded-full animate-pulse"></div>
                <div className="particle-drift absolute top-20 right-20 w-1 h-1 bg-foreground/15 dark:bg-white/15 rounded-full animate-pulse"></div>
                <div className="particle-drift absolute bottom-20 left-20 w-1.5 h-1.5 bg-foreground/20 dark:bg-white/20 rounded-full animate-pulse"></div>
                <div className="particle-drift absolute bottom-10 right-10 w-1 h-1 bg-foreground/15 dark:bg-white/15 rounded-full animate-pulse"></div>
                <div className="particle-drift absolute top-1/2 left-1/4 w-1 h-1 bg-foreground/15 dark:bg-white/15 rounded-full animate-pulse"></div>
                <div className="particle-drift absolute top-1/3 right-1/3 w-0.5 h-0.5 bg-foreground/10 dark:bg-white/10 rounded-full animate-pulse"></div>
              </div>
              ...
              <h3
                className="content-cascade text-xl font-mono text-foreground dark:text-white tracking-wider mb-6 relative z-10"
                style={{ animationDelay: "0.1s" }}
              >
                OEM
              </h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div
                  id="oem-modules-card"
                  className={`oem-card-emerge oem-card-hover oem-card border border-foreground/15 dark:border-white/15 rounded-lg overflow-hidden cursor-pointer hover:border-foreground/30 dark:hover:border-white/30 hover:shadow-lg transition-all duration-500 group transform hover:-translate-y-2 hover:scale-105 ${
                    isNavigating ? "opacity-50 pointer-events-none" : ""
                  }`}
                  style={{ animationDelay: "0.3s" }}
        ...
        <ScrollReveal delay={0.55}>
          {activePanel === "R & D" && (
            <div
              id="panel-r&d"
              className="rnd-panel-drag-expand border border-foreground/20 dark:border-white/20 rounded-2xl p-8 backdrop-blur-sm bg-foreground/5 dark:bg-white/5 shadow-2xl relative overflow-hidden"
              style={{
                transformOrigin: "center top",
                animationDelay: "0.1s",
              }}
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div
                  className={`rnd-card-emerge rnd-card-hover rnd-card border border-foreground/15 dark:border-white/15 rounded-lg overflow-hidden cursor-pointer hover:border-foreground/30 dark:hover:border-white/30 hover:shadow-lg transition-all duration-500 group transform hover:-translate-y-2 hover:scale-105 ${
                    isNavigating ? "opacity-50 pointer-events-none" : ""
                  }`}
                  style={{ animationDelay: "0.5s" }}
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <p className="text-xs font-mono text-foreground/70 dark:text-white/70 leading-relaxed mb-4">
